#' Title Modified KM Method For CFR In Individual Survival Data
...
#' @return method the source.
#' @return CFR_a the interpretation of method A.
#' @return CFR_b the interpretation of method B.
#' @return estimation the estimate at the study time,which contains method,Time(study time),CFR,Greedvar(Greedwood variance) and 95%CI.
