#' Title Estimate Coefficient values In Individual Survival Data
...
#' @return cov covariate.
#' @return estimate coefficient values.
#' @return var variance matrix
#' @return time study time
#' @return deaths number of death
