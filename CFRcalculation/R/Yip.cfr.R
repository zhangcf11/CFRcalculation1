#' Title Calculating CFR Using Chain Multinomial In Summarized Data
...
#'
#' @return CFR CFR
#' @return lower the lower of CFR's 95% CI
#' @return upper the upper of CFR's 95% CI
#' @return Var the variance of CFR
