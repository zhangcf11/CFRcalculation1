#' Title Simulate Individual Data Using Weibull Distribution
...
#'
#' @return id patient id number.
#' @return time1 entry time.
#' @return time2 the time of cure or death.
#' @return time survival time.
#' @return dc indicator of outcome.1-death,2-cure.
