#' Title Calculating CFR Using Parametric Method In Individual Data
...
#' @return estimation the estimate at the study time,which contains Time(study time),CFR,Var(variance) and 95%CI.
#' @return p parameter values
#' @return Var variance matrix
